...
final class ExcerptSummaryGeneratorTest extends TestCase
{
    public function test_returns_excerpt_truncated(): void
    {
        ...
        $snap = new DraftSnapshot(1, 't', '', 100, true, false, false, 0, 0, [], 1, '1d', '1d', $excerpt);
    ...
    {
        $snap = new DraftSnapshot(1, 't', '', 5, true, false, false, 0, 0, [], 1, '1d', '1d', 'short text here');
    ...
    {
        $snap = new DraftSnapshot(1, 't', '', 0, true, false, false, 0, 0, [], 1, '1d', '1d', '');
